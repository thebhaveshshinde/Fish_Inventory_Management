...
async function addUser(e: Event) {
  ...
  if (response.status === 200) {
    toast.add({
      title: "Success",
      description: "FIsherman Added Successfully !!",
